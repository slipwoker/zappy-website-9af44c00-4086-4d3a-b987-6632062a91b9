document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        function validateField(input) {
            ...
            } else if (value.length > 0 && value.length < 2 && input.tagName === 'INPUT' && type === 'text') {
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (!isFormValid) {
                ...
                setTimeout(function() {
                    ...
                    errorContainer.style.display = 'block';
                    errorContainer.style.backgroundColor = '#f0fff4';
                    errorContainer.style.border = '1px solid #9ae6b4';
                    errorContainer.style.color = '#276749';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '9af44c00-4086-4d3a-b987-6632062a91b9',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '9af44c00-4086-4d3a-b987-6632062a91b9';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '9af44c00-4086-4d3a-b987-6632062a91b9';
